...
export const subjectQuestions: Record<string, Question[]> = {
  English: [
    ...
    { id: 104, subject: "English", topic: "Idioms", question: "Idiom: To 'kick the bucket' means to ______.", options: ["Start a fight", "Be clumsy", "Die", "Play football"], correctAnswer: 2 },
    { id: 105, subject: "English", topic: "Literature", question: "Novel: Who is the protagonist of the recommended novel?", options: ["The King", "The Prince", "The Queen", "Subject to current year"], correctAnswer: 3 },
    ...
    { id: 107, subject: "English", topic: "Lexis", question: "Spellings: Identify the correctly spelt word.", options: ["Accommodation", "Accomodation", "Acommodation", "Acomodation"], correctAnswer: 0 },
    ...
    { id: 110, subject: "English", topic: "Lexis", question: "Register: A person who treats kidney diseases is a ______.", options: ["Neurologist", "Cardiologist", "Nephrologist", "Oncologist"], correctAnswer: 2 },
    ...
    { id: 113, subject: "English", topic: "Idioms", question: "Idiom: 'Under the weather' means ______.", options: ["Feeling ill", "Raining", "Happy", "Traveling"], correctAnswer: 0 },
    ...
    { id: 115, subject: "English", topic: "Lexis", question: "Identify the correctly spelt word.", options: ["Occurence", "Occurrence", "Occurrance", "Ocurence"], correctAnswer: 1 },
    ...
    { id: 117, subject: "English", topic: "Lexis", question: "Antonym: The crowd was very boisterous.", options: ["Quiet", "Loud", "Active", "Happy"], correctAnswer: 0 },
  ...
  Mathematics: [
    { id: 201, subject: "Mathematics", topic: "Algebra", question: "Simplify: x^2 - y^2", options: ["(x-y)^2", "(x+y)(x-y)", "x(x-y)", "(x+y)^2"], correctAnswer: 1 },
    { id: 202, subject: "Mathematics", topic: "Geometry", question: "What is the angle of a full circle?", options: ["90", "180", "270", "360"], correctAnswer: 3 },
    { id: 203, subject: "Mathematics", topic: "Algebra", question: "Solve for x: 2x + 5 = 15", options: ["10", "5", "2", "8"], correctAnswer: 1 },
    { id: 204, subject: "Mathematics", topic: "Calculus", question: "Find the derivative of x^3.", options: ["3x^2", "x^2", "3x", "2x^3"], correctAnswer: 0 },
    { id: 205, subject: "Mathematics", topic: "Probability", question: "What is the probability of picking a red ball from 3 red and 2 blue balls?", options: ["3/5", "2/5", "1/2", "3/2"], correctAnswer: 0 },
    { id: 206, subject: "Mathematics", topic: "Calculus", question: "Integrate 2x dx.", options: ["2", "x^2", "x^2 + C", "2x + C"], correctAnswer: 2 },
    { id: 207, subject: "Mathematics", topic: "Geometry", question: "The sum of angles in a triangle is?", options: ["90", "180", "360", "270"], correctAnswer: 1 },
    ...
    { id: 210, subject: "Mathematics", topic: "Logarithms", question: "Evaluate log10(100).", options: ["10", "2", "1", "100"], correctAnswer: 1 },
    { id: 211, subject: "Mathematics", topic: "Arithmetic", question: "What is the square root of 625?", options: ["15", "25", "35", "45"], correctAnswer: 1 },
    { id: 212, subject: "Mathematics", topic: "Algebra", question: "Solve for y: 3y - 9 = 0", options: ["3", "6", "9", "0"], correctAnswer: 0 },
    { id: 213, subject: "Mathematics", topic: "Arithmetic", question: "What is 15% of 200?", options: ["15", "20", "30", "40"], correctAnswer: 2 },
    { id: 214, subject: "Mathematics", topic: "Geometry", question: "How many sides has a heptagon?", options: ["6", "7", "8", "9"], correctAnswer: 1 },
    { id: 215, subject: "Mathematics", topic: "Arithmetic", question: "Find the value of 5! (factorial).", options: ["60", "120", "240", "10"], correctAnswer: 1 },
    { id: 216, subject: "Mathematics", topic: "Statistics", question: "The median of 1, 3, 5, 7, 9 is?", options: ["3", "5", "7", "9"], correctAnswer: 1 },
    { id: 217, subject: "Mathematics", topic: "Algebra", question: "Simultaneous Equations: x+y=5, x-y=1. x=?", options: ["2", "3", "4", "5"], correctAnswer: 1 },
    { id: 218, subject: "Mathematics", topic: "Mensuration", question: "Area of a triangle with base 10 and height 5?", options: ["25", "50", "15", "30"], correctAnswer: 0 },
